...
var InfoApi_1 = createCommonjsModule(function (module, exports) {
/* tslint:disable */
/* eslint-disable */
/**
 * OpenStax Event Capture API
...
class InfoApi extends runtime.BaseAPI {
    ...
    infoRaw() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => models.InfoResultsFromJSON(jsonValue));
        });
    }
    /**
     * Get info on event capture
...
unwrapExports(InfoApi_1);
var InfoApi_2 = InfoApi_1.InfoApi;
...
Object.defineProperty(exports, "__esModule", { value: true });
__exportStar(EventsApi_1, exports);
__exportStar(InfoApi_1, exports);
});
